...
public class ChallengeWrapper {
    public static final String RESOURCES_PATH_BLUEPRINT = "src/main/resources/2015/day%d.txt";
    ...
    public ChallengeWrapper(int dayNumber, Challenge<?, ?> challenge) {
        this(dayNumber, challenge,false, false);
    }

    public ChallengeWrapper(int dayNumber, Challenge<?, ?> challenge, boolean skip) {
        this(dayNumber, challenge, skip, false);
    }

    public void computeChallengeAnswers() {
        if (!skip) {
            long start = System.currentTimeMillis();
            challenge.compute(String.format(RESOURCES_PATH_BLUEPRINT, dayNumber));
